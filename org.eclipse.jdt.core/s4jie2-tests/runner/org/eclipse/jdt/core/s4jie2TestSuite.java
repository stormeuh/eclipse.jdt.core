...
public class s4jie2TestSuite {
	...
	public static void main(String[] args) throws IOException {
		...
		testCompile("issue30", false, "",
				...
				+ "----------\n"
				+ "1 problem (1 error)\n");
		testCompile("issue19", false, "",
				"----------\n"
				+ "1. ERROR in SOURCE_FILE_FULL_PATH (at line 28)\n"
				+ "	* @pre | this.x > 0\n"
				+ "	         ^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "2. ERROR in SOURCE_FILE_FULL_PATH (at line 29)\n"
				+ "	* @pre | x > 0\n"
				+ "	         ^\n"
				+ "This expression inspects an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "3. ERROR in SOURCE_FILE_FULL_PATH (at line 30)\n"
				+ "	* @pre | this.getX() > 0\n"
				+ "	         ^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "4. ERROR in SOURCE_FILE_FULL_PATH (at line 31)\n"
				+ "	* @pre | getX() > 0\n"
				+ "	         ^^^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "5. ERROR in SOURCE_FILE_FULL_PATH (at line 32)\n"
				+ "	* @pre | super.y > 0\n"
				+ "	         ^^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "6. ERROR in SOURCE_FILE_FULL_PATH (at line 33)\n"
				+ "	* @pre | super.getY() > 0\n"
				+ "	         ^^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "7. ERROR in SOURCE_FILE_FULL_PATH (at line 34)\n"
				+ "	* @pre | z.a > 0\n"
				+ "	         ^^^\n"
				+ "This expression inspects an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "8. ERROR in SOURCE_FILE_FULL_PATH (at line 35)\n"
				+ "	* @pre | z.getA() > 0\n"
				+ "	         ^\n"
				+ "This expression inspects an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "9. ERROR in SOURCE_FILE_FULL_PATH (at line 39)\n"
				+ "	* @throws IllegalArgumentException | this.x > 0\n"
				+ "	                                     ^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "10. ERROR in SOURCE_FILE_FULL_PATH (at line 40)\n"
				+ "	* @may_throw IllegalArgumentException | this.x > 0\n"
				+ "	                                        ^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "11. ERROR in SOURCE_FILE_FULL_PATH (at line 41)\n"
				+ "	* @inspects | this, z\n"
				+ "	              ^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "12. ERROR in SOURCE_FILE_FULL_PATH (at line 41)\n"
				+ "	* @inspects | this, z\n"
				+ "	                    ^\n"
				+ "This expression inspects an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "13. ERROR in SOURCE_FILE_FULL_PATH (at line 42)\n"
				+ "	* @mutates | this, z\n"
				+ "	             ^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "14. ERROR in SOURCE_FILE_FULL_PATH (at line 42)\n"
				+ "	* @mutates | this, z\n"
				+ "	                   ^\n"
				+ "This expression inspects an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "15. ERROR in SOURCE_FILE_FULL_PATH (at line 43)\n"
				+ "	* @mutates_properties | this.getX(), z.getA()\n"
				+ "	                        ^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "16. ERROR in SOURCE_FILE_FULL_PATH (at line 43)\n"
				+ "	* @mutates_properties | this.getX(), z.getA()\n"
				+ "	                                     ^\n"
				+ "This expression inspects an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "17. ERROR in SOURCE_FILE_FULL_PATH (at line 45)\n"
				+ "	* @post | old(this.x) > 0\n"
				+ "	              ^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "18. ERROR in SOURCE_FILE_FULL_PATH (at line 46)\n"
				+ "	* @post | old(x) > 0\n"
				+ "	              ^\n"
				+ "This expression inspects an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "19. ERROR in SOURCE_FILE_FULL_PATH (at line 47)\n"
				+ "	* @post | old(this.getX()) > 0\n"
				+ "	              ^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "20. ERROR in SOURCE_FILE_FULL_PATH (at line 48)\n"
				+ "	* @post | old(getX()) > 0\n"
				+ "	              ^^^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "21. ERROR in SOURCE_FILE_FULL_PATH (at line 49)\n"
				+ "	* @post | old(super.y) > 0\n"
				+ "	              ^^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "22. ERROR in SOURCE_FILE_FULL_PATH (at line 50)\n"
				+ "	* @post | old(super.getY()) > 0\n"
				+ "	              ^^^^^\n"
				+ "This expression refers to an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "23. ERROR in SOURCE_FILE_FULL_PATH (at line 51)\n"
				+ "	* @post | old(z.a) > 0\n"
				+ "	              ^^^\n"
				+ "This expression inspects an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
				+ "24. ERROR in SOURCE_FILE_FULL_PATH (at line 52)\n"
				+ "	* @post | old(z.getA()) > 0\n"
				+ "	              ^\n"
				+ "This expression inspects an object before its constructor is executed, which is not allowed\n"
				+ "----------\n"
	    ...
	    testCompileAndRunMultifile("disable_fsc4j", true,
	    		".\n"
	    		+ "+-- JUnit Jupiter [OK]\n"
	    		+ "| '-- FooTest [OK]\n"
	    		+ "|   '-- testFoo() [OK]\n"
